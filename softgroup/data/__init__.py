...
from .s3dis_spf import S3DISInstDataset

__all__ = ['S3DISDataset', 'ScanNetDataset', 'S3DISInstDataset', 'build_dataset']
...
def build_dataset(data_cfg, logger):
    ...
    elif data_type == 's3dis_spf':
        return S3DISInstDataset(**_data_cfg)
    else:
