...
class Instances3D:
    ...
    def __init__(self, num_points: int, **kwargs: Any):
        """
        Args:
    ...
    def to(self, *args: Any, **kwargs: Any) -> "Instances3D":
        ...
        """
        ret = Instances3D(self._num_points)
    ...
    def cat(instance_lists: List["Instances3D"]) -> "Instances3D":
        ...
        num_points = instance_lists[0].num_points
        if not isinstance(num_points, torch.Tensor):  # could be a tensor in tracing
            for i in instance_lists[1:]:
                assert i.image_size == num_points
        ret = Instances3D(num_points)
